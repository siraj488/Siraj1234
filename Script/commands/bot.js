...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "@Lèøñtī Jéèñ") || (event.body.toLowerCase() == "@আমি অনেক খারাপ ছেলে")) {
     return api.sendMessage("🥰-সুইট-🌺 আমার বস সিরাজ'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️⛏️", threadID);
   };
